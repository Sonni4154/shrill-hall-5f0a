...
> [!IMPORTANT]
> When using C3 to create this project, select "no" when it asks if you want to deploy. You need to follow this project's [setup steps](https://github.com/cloudflare/templates/tree/main/shrill-hall-5f0a#setup-steps) before deploying.
...
```bash
npm create cloudflare@latest -- --template=cloudflare/templates/shrill-hall-5f0a
```

A live public deployment of this template is available at [https://shrill-hall-5f0a.templates.workers.dev](https://shrill-hall-5f0a.templates.workers.dev)
